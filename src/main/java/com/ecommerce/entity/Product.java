...
public class Product {
	...
	public java.lang.String toString() {
		return "Product(productId=" + this.getProductId() + ", name=" + this.getName() + ", description=" + this.getDescription() + ", price=" + this.getPrice() + ", stock=" + this.getStock() + ", category=" + this.getCategory() + ", imageUrl=" + this.getImageUrl() + ", active=" + this.getActive() + ", createdAt=" + this.getCreatedAt() + ", updatedAt=" + this.getUpdatedAt() + ")";
	}
}
