...
public class AdminProductRequest {
	...
	public boolean equals(final java.lang.Object o) {
		...
		if (!(o instanceof AdminProductRequest)) return false;
		final AdminProductRequest other = (AdminProductRequest) o;
	...
	protected boolean canEqual(final java.lang.Object other) {
		return other instanceof AdminProductRequest;
	}
	...
	public java.lang.String toString() {
		return "AdminProductRequest(name=" + this.getName() + ", description=" + this.getDescription() + ", price=" + this.getPrice() + ", stock=" + this.getStock() + ", category=" + this.getCategory() + ", imageUrl=" + this.getImageUrl() + ", active=" + this.getActive() + ")";
	}
}
